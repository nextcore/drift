...
//
// Before including this header, the backend file must:
//   1. Include the bridge header and all required Skia/system headers
//   2. Open an anonymous namespace
//   3. Provide these backend-specific declarations inside the namespace:
//      - sk_sp<SkFontMgr> get_font_manager();
//
// After including this header, the backend file must:
//   1. Close the anonymous namespace
//   2. Define the kDefaultFontFamilies weak symbol
//   3. Provide backend-specific extern "C" functions (context/surface creation)
//   4. Provide the remaining extern "C" shared function definitions via
...
#endif  // DRIFT_SKIA_COMMON_IMPL_H
